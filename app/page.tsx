  ...
  <span className="text-white/25 transition group-hover:translate-x-1 group-hover:text-white/70"> 
    → 
      ...
      {/* ==================================
          RAAKA MUSIC PLAYER
          ================================== */}
      <div className="fixed bottom-5 right-5 z-[95] md:bottom-7 md:right-7">
        <div className="relative flex items-center gap-2 rounded-full border border-white/15 bg-black/70 p-1.5 shadow-[0_18px_60px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
          <button
            ...
            className={`flex h-10 max-w-[170px] items-center gap-2 rounded-full px-3 text-left transition-all duration-300 ${
          ...
          >
            <span className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-white/15 text-[12px] ${
              musicPlaying ? "text-orange-300" : "text-white/45"
            }`}>
              ♪
            </span>
            <span className="min-w-0 truncate text-[9px] font-medium uppercase tracking-[0.18em]">
              {RAAKA_PLAYLIST[musicIndex].title}
            </span>
          </button>
          ...
          {musicOpen && (
            <div className="absolute bottom-[52px] right-0 w-[230px] overflow-hidden rounded-2xl border border-white/15 bg-black/90 p-2 shadow-[0_20px_70px_rgba(0,0,0,0.7)] backdrop-blur-2xl">
